 ...
 * Maps UI column names to API category and form type
 */
const parseColumnName = (
  columnName: string
): { category: string; formType: string } => {
